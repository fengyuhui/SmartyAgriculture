...
<body>
						...
						<div class="col-xs-12">
							...
							<h4 class="pink">
								...
								<a href="#modal-table" role="button" class="green"
									data-toggle="modal" style="color: #438eb9!important;font-size: 26px;"> ${goodsName} 销售额统计 </a>/
							    <a href="<%=request.getContextPath()%>/product/productInputStatistics/0/1/prvious/0/0/${goodsId}" role="button" class="green"
									data-toggle="modal"> 进货统计 </a>
							...
							<div class="hr hr-18 dotted hr-double"></div>
								...
								<form class="form-search" id="exportExcel">
									<span class="span_margin"> 统计时间:</span> <input
										...
										data-date-format="yyyy-mm-dd" readonly size="16" /> <span
										class="add-on"><i class="icon-calendar"></i> </span><span class="span_margin">订单状态:</span>
									 <select
										name="goodsStatus" class="input_border" id="orderStatus" data-checked="${saleStatus}" 
										><option
									...
									<div style="float: right;"><a href="javascript:void(0);" onclick="exportExcel('${goodsId}')" style="font-size:16px;">导出excel</a></div>
													...
													<td colspan="10" style="text-align:left"><c:if
															...
															<div align="right" class="viciao">
																<a href="javascript:void();"
																	...
																	onclick="dividePage('${goodsId}','${allPages}','${currentPage}','prvious'">&nbsp;&lt;&nbsp;
																	Prev &nbsp;</a>
																<%
	...
	<script
		src="<%=request.getContextPath()%>/js/echarts/config.js"></script>
	  <script type="text/javascript">
      ...
      var src = "product/echartsProductStatistics/" + statusSelected + "/"
		+ starttime2+"/"+endtime2+"/"+goodsId;
   $.ajax({ 
	        type:"POST", 
            url:src,
	    	dataType : "json",
...
<script
	...
	<script src="<%=request.getContextPath()%>/js/statistics/productStatistics.js"></script>
		<script
