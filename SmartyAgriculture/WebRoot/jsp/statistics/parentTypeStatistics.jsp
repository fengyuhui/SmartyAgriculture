...
<body>
						...
						<div class="col-xs-12">
							...
							<h4 class="pink">
								...
								<a href="#modal-table" role="button" class="green"
									data-toggle="modal"> ${typeName} 类销售额统计 </a>
							</h4>
							<div class="hr hr-18 dotted hr-double"></div>
							<div class="nav-search" id="nav-search">
								<form class="form-search" id="exportExcel" action="">
									<span class="span_margin"> 统计时间:</span><input
										...
										data-date-format="yyyy-mm-dd" readonly size="16" /> <span
										class="add-on"><i class="icon-calendar"></i> </span> <span
										class="span_margin">订单状态:</span> <select name="goodsStatus"
										class="input_border" id="orderStatus"
										...
										onclick="TimeChange(${typeIdParent})" />
									<div style="float: right;">
										<a href="javascript:void(0);"
											onclick="exportExcel('${typeIdParent}')"
								...
								<div class="col-xs-12">
									...
									<div class="table-responsive">
										<table id="sample-table-2"
											...
											<tbody>
												<c:forEach items="${typeStatisticsList}" var="item">
													<tr>
													...
													<td colspan="10" style="text-align:left"><c:if
															...
															<div align="right" class="viciao">
																<a href="javascript:void();"
																	onclick="dividePage('${typeIdParent}','${allPages}','${currentPage}','first')">&nbsp;
																	首 页 &nbsp;</a> <a href="javascript:void();"
																	onclick="dividePage('${typeIdParent}','${allPages}','${currentPage}','prvious'">&nbsp;&lt;&nbsp;
																	Prev &nbsp;</a>
																<%
																...
																%>
																<a href="javascript:void();"
																	onclick="dividePage('${typeIdParent}','${allPages}','${currentPage}','<%=i%>')"><%=i%></a>
																<%
																	}
																		}
																%>
																<a href="javascript:void();"
																	onclick="dividePage('${typeIdParent}','${allPages}','${currentPage}','next')">&nbsp;Next&nbsp;&gt;&nbsp;</a>
																<a href="javascript:void();"
																	onclick="dividePage('${typeIdParent}','${allPages}','${currentPage}','last')">&nbsp;尾
																	页&nbsp; </a>
															</div>
														</c:if></td>
												</tr>
	...
	<script type="text/javascript">
	  ...
	  $("#orderStatus").val(statusSelected);
        ...
        var typeIdParent="${typeIdParent}";
      myChart.setOption(option);
      var src = "type/echartsParentTypeStatistics/" + status + "/"
		+ starttime2+"/"+endtime2 +"/"+typeIdParent;
   $.ajax({ 
	        type:"POST", 
            url:src,
	    	dataType : "json",
	...
	<script
		src="<%=request.getContextPath()%>/js/statistics/parentTypeStatistics.js"></script>
