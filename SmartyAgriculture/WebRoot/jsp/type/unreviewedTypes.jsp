...
<%
	...
	//本页面url，翻页用
	String url = "/goodsType/typeReview/";
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<h4 class="pink">
									...
									<a href="type/getTypeList/0/1/prvious/0/0" role="button" class="green" data-toggle="modal">产品分类审核列表 </a>
								</h4>								
								<div class="hr hr-18 dotted hr-double"></div>
								<div class="row">
									<div class="col-xs-12">
											...
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												...
												<c:forEach items="${records}" var="item">
													<tr>
														...
														<td>
															<img src="${item.picture}" style="height:35px"/>
														</td>
														<td>
															${item.level }
														</td>
														...
														<td>
															${item.status == 1 ? "发布未审核":"草稿"}
														 </td>
																											
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																<a class="green" href="type/doReview?id=${item.id}">
																	<i class="icon-ok bigger-110"></i>
																</a>
																<a class="green" href="type/unDo?id=${item.id}">
