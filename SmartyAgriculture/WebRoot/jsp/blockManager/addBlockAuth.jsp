...
<body>
	<div class="page-content">
		<div class="page-header">
			<h1>
				添加区域管理员信息 <small> <i class="icon-double-angle-right"></i>
				</small>
			</h1>
		</div>
		<!-- /.page-header -->
		<div class="row">
			<div class="col-xs-12">
				...
				<form class="form-horizontal" action="blockManager/addBlockManagerPost"
					method="post" enctype="multipart/form-data">
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right"
							for="form-input-readonly">区域管理员名称(必填)</label>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="password" class="col-xs-10 col-sm-5"
								id="form-input-readonly" name="password" value="" name="description" />							
						</div>
					</div>
