						...
						<div class="row">
							<div class="col-xs-12">
								...
								<h4 class="pink">
									...
									<a href="album/add" role="button" class="green" data-toggle="modal"> 添加相册列表 </a>
									&nbsp;&nbsp;&nbsp;
									<i class="icon-hand-right icon-animated-hand-pointer blue"></i>
									<a href="album/judge/0/1/prvious" role="button" class="green" data-toggle="modal"> 审查相册图列表 </a>
								</h4>								
								<div class="hr hr-18 dotted hr-double"></div>
													...
													<tr>
														...
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																<!-- 查看信息操作 -->
																<a class="blue" href="album/find?id=${item.id}">
																	<i class="icon-zoom-in bigger-130"></i>
																</a>
																<c:if test="${item.status ==0}">
																<!-- 编辑信息操作 -->
																<a class="green" href="album/update?id=${item.id}">
																	<i class="icon-pencil bigger-130"></i>
																</a>		
																</c:if>
																<!-- 删除 -->
																<a class="green" href="album/deleteRequest?id=${item.id}">
