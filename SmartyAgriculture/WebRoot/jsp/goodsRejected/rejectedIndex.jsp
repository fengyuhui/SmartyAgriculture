...
<body>
								...
								<div class="col-xs-12">
									...
									<div class="table-responsive">
										<table id="sample-table-2"
											...
											<tbody>
												<c:forEach items="${goodsRejectedViewsList}" var="item">
													<tr>
														<td>${item.id}</td>
														...
														<td>${item.money}</td>
														<td>
														<fmt:formatDate value="${item.rejectedTime}" type="both" />
														</td>
												...
												<tr>
													...
													<td colspan="10" style="text-align:left"><c:if
															...
															<div align="right" class="viciao">
																<a href="goodsRejected/rejectedIndex/${allPages}/${currentPage}/first"
																	>&nbsp;
																	首 页 &nbsp;</a> <a href="goodsRejected/rejectedIndex/${allPages}/${currentPage}/prvious"
																	>&nbsp;&lt;&nbsp;
																	Prev &nbsp;</a>
																<%
																...
																%>
																<a href="goodsRejected/rejectedIndex/${allPages}/${currentPage}/<%=i%>"><%=i%></a>
																<%
																	}
																		}
																%>
																<a href="goodsRejected/rejectedIndex/${allPages}/${currentPage}/next"
																	onclick="dividePage('${allPages}','${currentPage}','next')">&nbsp;Next&nbsp;&gt;&nbsp;</a>
																<a href="goodsRejected/rejectedIndex/${allPages}/${currentPage}/last"
																	>&nbsp;尾
																	页&nbsp; </a>
															</div>
														</c:if></td>
	...
	<script src="<%=request.getContextPath()%>/js/goodsRejected/goodsRejected.js"></script>
</body>
</html>
