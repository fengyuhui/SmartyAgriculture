...
<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/css/farmMessage/addFarmMessage.css">
<script type="text/javascript"
	src="<%=request.getContextPath()%>/js/farmMessage/addFarmMessage.js"></script>
...
<body>
	...
	<div class="page-content">
		<div class="page-header">
			<h1>
				修改农场信息 <small> <i class="icon-double-angle-right"></i>
				</small>
			</h1>
		</div>
		<!-- /.page-header -->
		<div class="row">
			<div class="col-xs-12">
				...
				<form class="form-horizontal" action="farmMessage/updatePost"
					method="post" enctype="multipart/form-data">
					<input value="${farmMessage.id}" style="display:none" name="id"></input>
					<input value="${farmMessage.messageType}" style="display:none" name="messageType"></input>
					<div class="form-group">
						...
						<input type="text" class="col-xs-10 col-sm-5"
								id="form-input-readonly" value="${farmMessage.messageName}" name="messageName" data-default="${farmMessage.messageName}"/> <span
					...
					<div class="form-group">
                                                            <label class="col-sm-3 control-label no-padding-right"
                                                                      for="form-input-readonly">副标题</label>

                                                            <div class="col-sm-9">
                                                                      <input type="text" class="col-xs-10 col-sm-5"
                                                                                id="form-input-readonly" value="${farmMessage.subTitle}" name="subTitle" data-default="${farmMessage.subTitle}"/> 
                                                                                <span
...
var content='${farmMessage.currentMessage}';
ue.ready(function(){
