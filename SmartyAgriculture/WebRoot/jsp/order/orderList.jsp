				...
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
				           ...
				           <div class="nav-search" id="nav-search" style="text-align: left;">
										...
										<table id="sample-table-2"
											...
											<tbody>
												<c:forEach items="${orderView}" var="item">
													<tr>
														<td>${item.orderView.orderId}</td>
														<td>${item.orderView.amount}</td>
														...
														<td class="hidden-480"><c:if
															...
															<c:if
																...
																<select name="order_status"
																	onchange="updateOrderStatus('${item.orderView.orderId}',this,${item.orderView.pick_up})"><option
																	value="2"
															...
															<c:if test="${item.orderView.status==4}">
																...
																<select name="order_status"
																	onchange="updateOrderStatus('${item.orderView.orderId}',this)"><option
																		value="5"
															...
															<div class="visible-md visible-lg hidden-xs action-buttons">
																<!-- 查看订单信息操作 -->
																<a class="blue"
																	href="interface/order/getOrderDetailList?orderId=${item.orderView.orderId }">
