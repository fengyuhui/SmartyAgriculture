						...
						<div class="row">
							<div class="col-xs-12">
								...
								<h4 class="pink">
									...
									data-toggle="modal" style="color: #438eb9!important;font-size: 26px;"> 地块列表 </a>/
									<a href="<%=request.getContextPath()%>/blockAudit/auditIndex/0/1/prvious" role="button" class="green"
									data-toggle="modal"> 审核地块操作 </a>
								</h4>
								<div class="hr hr-18 dotted hr-double"></div>
													...
													<c:forEach items="${blockList}" var="item">
														...
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																<!-- 查看土地信息操作 -->
																<a class="blue" href="block/detail/${item.getBlockId()}">
																	<i class="icon-zoom-in bigger-130"></i>
																</a>
																<!-- 编辑土地信息操作 -->
																<a class="green" href="block/edit/${item.getBlockId()}">
																	<i class="icon-pencil bigger-130"></i>
																</a>
																<a class="red"
																	href="block/delete/${item.getBlockId()}"> <i
