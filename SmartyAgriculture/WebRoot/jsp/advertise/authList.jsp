						...
						<div class="row">
							<div class="col-xs-12">
								...
								<h4 class="pink">
									...
									<a href="advertise/index/0/1/prvious" role="button" class="green" data-toggle="modal">轮播图列表 </a>
								</h4>								
								<div class="hr hr-18 dotted hr-double"></div>
													...
													<tr>
														...
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																...
																<c:if test="${item.status == 1}">
																<!-- 确认信息发布 -->
																<a class="green" href="advertise/judgePublish?advertiseId=${item.id}">
																	<i class="icon-check bigger-130"></i>
																</a>		
																</c:if>
																<c:if test="${item.status == 2}">
																<!-- 确认草稿信息操作 -->
																<a class="green" href="advertise/judgeDraft?advertiseId=${item.id}">
																	<i class="icon-check bigger-130"></i>
																</a>		
																</c:if>
																<c:if test="${item.status == 4}">
																<!-- 确认草稿信息操作 -->
																<a class="green" href="advertise/delete?advertiseId=${item.id}">
																	<i class="icon-check bigger-130"></i>
																</a>		
																</c:if>
																<!-- 真实删除 -->
																...
																<!-- 撤销删除 -->
																<c:if test="${item.status == 4}">
																<a class="green" href="advertise/rebackDeleteRequest?advertiseId=${item.id}">
																	<i class="icon-remove bigger-130"></i>
																</a>
																</c:if>
															</div>
