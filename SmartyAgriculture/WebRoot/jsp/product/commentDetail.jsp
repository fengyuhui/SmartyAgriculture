							...
							<div class="profile-user-info profile-user-info-striped">
								...
								<div class="profile-info-row">
									...
									<div class="profile-info-row">
										...
										<div class="profile-info-value">
											<label> 
											<c:if test="${commentView.commentStatus==0}"><input name="form-field-checkbox"
												class="ace ace-checkbox-2" type="checkbox"
												onchange="statusHidden(${commentView.id})" /> <span class="lbl">隐藏</span>
												</c:if>
												<c:if test="${commentView.commentStatus==1}">
												已设置隐藏，待审核
												</c:if>
											</label>
										</div>
