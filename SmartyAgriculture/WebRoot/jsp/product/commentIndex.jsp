						...
						<div class="col-xs-12">
							...
							<h4 class="pink">
								...
								<a href="#modal-table" role="button" class="green"
									data-toggle="modal"
									style="color: #438eb9!important;font-size: 26px;">评论列表 </a>/ <a
									href="<%=request.getContextPath()%>/comment/commentAuditIndex/0/1/prvious"
									role="button" class="green" data-toggle="modal"> 审核评论操作 </a>
							</h4>
							<div class="hr hr-18 dotted hr-double"></div>
							<!-- #nav-search -->
							<div class="row">
											...
											<tbody>
												<c:forEach items="${commentList}" var="item">
													<tr>
														...
														<td><a href="javascript:void(0);">${item.goodsName} </a></td>
														<td>${item.userName}</td>
														...
														<td>
															<div
																...
																<!-- 查看商品信息操作 -->
																<a class="blue" href="comment/commentDetail/${item.id}">
												...
												<tr>
													<td colspan="10" style="text-align:left"><c:if
															...
															<div align="right" class="viciao">
																<a
																	href="comment/commentIndex/${allPages}/${currentPage}/first">&nbsp;
																	首 页 &nbsp;</a> <a
																	href="comment/commentIndex/${allPages}/${currentPage}/prvious">&nbsp;&lt;&nbsp;
																	Prev &nbsp;</a>
																<%
																...
																%>
																<a
																	href="comment/commentIndex/${allPages}/${currentPage}/<%=i%>"><%=i%></a>
																<%
																	}
																		}
																%>
																<a
																	href="comment/commentIndex/${allPages}/${currentPage}/next">&nbsp;Next&nbsp;&gt;&nbsp;</a>
																<a
																	href="comment/commentIndex/${allPages}/${currentPage}/last">&nbsp;尾
																	页&nbsp; </a>
															</div>
														</c:if></td>
												</tr>
