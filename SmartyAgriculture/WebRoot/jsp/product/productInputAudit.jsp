						...
						<div class="col-xs-12">
							...
							<h4 class="pink">
								...
								<a href="#modal-table" role="button" class="green"
									data-toggle="modal"
									style="color: #438eb9!important;font-size: 26px;"> 审核商品进货操作
								</a>
							</h4>
							<div class="hr hr-18 dotted hr-double"></div>
							<div class="row">
								<div class="col-xs-12">
									...
									<div class="table-responsive">
										<table id="sample-table-2"
											...
											<tbody>
												<c:forEach items="${inputGoodsViewsList}" var="item">
													<tr>
														<td>${item.id}</td>

														<td><a href="javascript:void(0);">${item.name} </a></td>
														<td><a href="javascript:void(0);">${item.num} </a></td>
														<td><a href="javascript:void(0);">${item.unit} </a></td>
														<td><fmt:formatDate value="${item.add_time}"
																type="both" /></td>
														<td>
															<div
																...
																<a class="blue" href="javascript:void(0);"
																	onclick="updateInputGoodsStatus(${item.id},1)"> <i
																	class="icon-ok  bigger-130" title="审核通过"></i>
																</a>| <a class="blue" href="javascript:void(0);"
																	onclick="updateInputGoodsStatus(${item.id},2)"> <i
																	class="icon-remove bigger-130" title="审核拒绝"></i>
																</a>
															</div>
														</td>
													</tr>
												...
												<tr>
													<td colspan="10" style="text-align:left"><c:if
															...
															<div align="right" class="viciao">
																<a
																	href="product/auditInputGoods/${allPages}/${currentPage}/first">&nbsp;
																	首 页 &nbsp;</a> <a
																	href="product/auditInputGoods/${allPages}/${currentPage}/prvious">&nbsp;&lt;&nbsp;
																	Prev &nbsp;</a>
																<%
																...
																%>
																<a
																	href="product/auditInputGoods/${allPages}/${currentPage}/<%=i%>"><%=i%></a>
																<%
																	}
																		}
																%>
																<a
																	href="product/auditInputGoods/${allPages}/${currentPage}/next">&nbsp;Next&nbsp;&gt;&nbsp;</a>
																<a
																	href="product/auditInputGoods/${allPages}/${currentPage}/last">&nbsp;尾
																	页&nbsp; </a>
															</div>
														</c:if></td>
												</tr>
