...
<body>
	<div class="page-content">
		<div class="page-header">
			<h1>
				添加摄像头 <small> <i class="icon-double-angle-right"></i>
				</small>
			</h1>
		</div>
		<!-- /.page-header -->
		<div class="row">
			<div class="col-xs-12">
				...
				<form class="form-horizontal" action="camera/addPost"
					...
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right"
							for="form-input-readonly">IP地址</label>
					...
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right"
							for="form-input-readonly">端口</label>
					...
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right"
							for="form-input-readonly">登陆名</label>
					...
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right"
							for="form-input-readonly">设备端口号</label>

						<div class="col-sm-9">
							<input type="text" name="device_port">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right"
