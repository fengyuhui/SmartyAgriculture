package cn.bupt.smartyagl.unionpay;
...
import cn.bupt.smartyagl.unionpay.sdk.AcpService;
import cn.bupt.smartyagl.unionpay.sdk.LogUtil;
import cn.bupt.smartyagl.unionpay.sdk.SDKConfig;
...
public class SendPayInfo {
	 ...
	 * @param orderId
	 */
	public static String sendUnionPay(String orderId,String money,String channelType){
...
//		String orderId = req.getParameter("orderId");
		...
		String txnTime = df.format(new Date());//req.getParameter("txnTime");
		...
		contentData.put("channelType",channelType);          		 	//渠道类型 08手机； 07:pc、平板
		...
		contentData.put("txnAmt", money);						//交易金额 单位为分，不能带小数点
...
//		//从响应报文中提取tn
//		int start=rspMessage.indexOf("tn");
//		String tn=rspMessage.substring(start+3,start+24);
//		return tn;
