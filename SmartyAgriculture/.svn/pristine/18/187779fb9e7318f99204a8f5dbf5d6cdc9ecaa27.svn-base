						...
						<div class="row">
							<div class="col-xs-12">
								...
								<h4 class="pink">
									...
									<a href="album/index/0/1/prvious" role="button" class="green" data-toggle="modal">返回相册列表 </a>
								</h4>								
								<div class="hr hr-18 dotted hr-double"></div>
													...
													<tr>
														...
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																...
																<c:if test="${item.status == 1}">
																<!-- 确认信息发布 -->
																<a class="green" href="album/judgePublish?id=${item.id}">
																	<i class="icon-check bigger-130"></i>
																</a>		
																</c:if>
																<c:if test="${item.status == 2}">
																<!-- 确认草稿信息操作 -->
																<a class="green" href="album/judgeDraft?id=${item.id}">
																	<i class="icon-check bigger-130"></i>
																</a>		
																</c:if>
																<!-- 删除 -->
																<a class="green" href="album/delete?id=${item.id}">
