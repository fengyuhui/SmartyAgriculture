						...
						<div class="row">
							<div class="col-xs-12">
								...
								<h4 class="pink">
									...
									<a href="adminUser/addAdmin" role="button" class="green" data-toggle="modal"> 添加管理员 </a>
								</h4>								
								<div class="hr hr-18 dotted hr-double"></div>
													...
													<tr>
														...
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																<!-- 查看信息操作 -->
																<a class="blue" href="adminUser/selectAdmin?name=${item.name}">
																	<i class="icon-zoom-in bigger-130"></i>
																</a>
																<!-- 编辑信息操作 -->
																<a class="green" href="adminUser/update?id=${item.id}">
