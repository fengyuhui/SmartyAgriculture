...
<body>
	<div class="page-content">
		<div class="page-header">
			<h1>
				发布农场相册图 <small> <i class="icon-double-angle-right"></i>
				</small>
			</h1>
		</div>
		<!-- /.page-header -->
		<div class="row">
			<div class="col-xs-12">
				...
				<form class="form-horizontal" action="album/addPost"
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" class="col-xs-10 col-sm-5"
								id="form-input-readonly" name="photoName" value="" name="description" style="width:30%"/>							
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="file" id="first_file" name="file">
						</div>
					</div>
