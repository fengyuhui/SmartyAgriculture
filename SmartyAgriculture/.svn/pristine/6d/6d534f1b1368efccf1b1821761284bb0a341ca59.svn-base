					...
					<div class="page-content">
						<div class="row">
							...
							<h4 class="pink">
								...
								<a href="javascript:void(0);" role="button" class="green"
									data-toggle="modal"> 购物卡列表 </a>
							</h4>								
									...
									<div class="col-xs-12">										
										<div class="table-responsive">
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												...
												<tbody>
												<c:forEach items="${goodsCartList}" var="item">
													<tr>
														<td class="center">
															${item.number}
														</td>
														...
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																<!-- 查看信息操作 -->
																<a class="blue" href="goodsCard/cardLogIndex/0/1/prvious?cardId=${item.number}">
